...
def main(number_of_x, without_min_covers, without_min_covers_approx, without_with_supervised_learning, without_with_supervised_learning_1, path):
...
if __name__ == '__main__':
    ...
    main(number_of_x, without_min_covers, without_min_covers_approx, without_with_supervised_learning, without_with_supervised_learning_1, path)
