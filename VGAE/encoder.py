...
class Encoder(nn.Module):
    def __init__(self, number_of_features, number_of_classes):
        ...
        for number_of_hidden_feats_index in range(len(number_of_hidden_features) - 1):
            self.hiddens_mu.append(GCNConv(number_of_hidden_features[number_of_hidden_feats_index], number_of_hidden_features[number_of_hidden_feats_index + 1]))
            self.hiddens_logstd.append(GCNConv(number_of_hidden_features[number_of_hidden_feats_index], number_of_hidden_features[number_of_hidden_feats_index + 1]))
